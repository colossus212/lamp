...
__IO uint16_t ADC1ConvertedValue[ADC_BUFFER_SIZE];//ADC1
__IO uint16_t ADC2ConvertedValue[ADC_BUFFER_SIZE];//ADC2
__IO uint16_t ADC3ConvertedValue[ADC_BUFFER_SIZE];//ADC3

adc_io adc[adc_size] = {{ADC_Channel_0,GPIOA, GPIO_Pin_0}, {ADC_Channel_1,GPIOA, GPIO_Pin_1}, 
						{ADC_Channel_2,GPIOA, GPIO_Pin_2}, {ADC_Channel_3,GPIOA, GPIO_Pin_3},
						{ADC_Channel_0,GPIOC, GPIO_Pin_0}, {ADC_Channel_1,GPIOC, GPIO_Pin_1}, 
						{ADC_Channel_2,GPIOC, GPIO_Pin_2}, {ADC_Channel_3,GPIOC, GPIO_Pin_3}};
...
{//开始ADC2 DMA 顺序采样AIN0,AIN1,AIN2
	...
	ADC_RegularChannelConfig(ADC2, adc[0].ADC_CH, 1, ADC_SampleTime_28Cycles);
	ADC_RegularChannelConfig(ADC2, adc[1].ADC_CH, 2, ADC_SampleTime_28Cycles);
	ADC_RegularChannelConfig(ADC2, adc[2].ADC_CH, 3, ADC_SampleTime_28Cycles);
	ADC_RegularChannelConfig(ADC2, adc[3].ADC_CH, 4, ADC_SampleTime_28Cycles);
	ADC_RegularChannelConfig(ADC2, adc[0].ADC_CH, 5, ADC_SampleTime_28Cycles);
	ADC_RegularChannelConfig(ADC2, adc[1].ADC_CH, 6, ADC_SampleTime_28Cycles);
	ADC_RegularChannelConfig(ADC2, adc[2].ADC_CH, 7, ADC_SampleTime_28Cycles);
	ADC_RegularChannelConfig(ADC2, adc[3].ADC_CH, 8, ADC_SampleTime_28Cycles);
	ADC_RegularChannelConfig(ADC2, adc[0].ADC_CH, 9, ADC_SampleTime_28Cycles);
	ADC_RegularChannelConfig(ADC2, adc[1].ADC_CH,10, ADC_SampleTime_28Cycles);
	ADC_RegularChannelConfig(ADC2, adc[2].ADC_CH,11, ADC_SampleTime_28Cycles);
	ADC_RegularChannelConfig(ADC2, adc[3].ADC_CH,12, ADC_SampleTime_28Cycles);
	ADC_RegularChannelConfig(ADC2, adc[4].ADC_CH,13, ADC_SampleTime_28Cycles);
	ADC_RegularChannelConfig(ADC2, adc[5].ADC_CH,14, ADC_SampleTime_28Cycles);
	ADC_RegularChannelConfig(ADC2, adc[6].ADC_CH,15, ADC_SampleTime_28Cycles);
	ADC_RegularChannelConfig(ADC2, adc[7].ADC_CH,16, ADC_SampleTime_28Cycles);	
...
{//开始ADC3 DMA循序采样AIN2,AIN0,AIN1	
	...
	ADC_RegularChannelConfig(ADC3, adc[3].ADC_CH, 1, ADC_SampleTime_28Cycles);
	ADC_RegularChannelConfig(ADC3, adc[2].ADC_CH, 2, ADC_SampleTime_28Cycles);
	ADC_RegularChannelConfig(ADC3, adc[1].ADC_CH, 3, ADC_SampleTime_28Cycles);
	ADC_RegularChannelConfig(ADC3, adc[0].ADC_CH, 4, ADC_SampleTime_28Cycles);
	ADC_RegularChannelConfig(ADC3, adc[3].ADC_CH, 5, ADC_SampleTime_28Cycles);
	ADC_RegularChannelConfig(ADC3, adc[2].ADC_CH, 6, ADC_SampleTime_28Cycles);
	ADC_RegularChannelConfig(ADC3, adc[1].ADC_CH, 7, ADC_SampleTime_28Cycles);
	ADC_RegularChannelConfig(ADC3, adc[0].ADC_CH, 8, ADC_SampleTime_28Cycles);
	ADC_RegularChannelConfig(ADC3, adc[3].ADC_CH, 9, ADC_SampleTime_28Cycles);
	ADC_RegularChannelConfig(ADC3, adc[2].ADC_CH,10, ADC_SampleTime_28Cycles);
	ADC_RegularChannelConfig(ADC3, adc[1].ADC_CH,11, ADC_SampleTime_28Cycles);
	ADC_RegularChannelConfig(ADC3, adc[0].ADC_CH,12, ADC_SampleTime_28Cycles);
	ADC_RegularChannelConfig(ADC3, adc[7].ADC_CH,13, ADC_SampleTime_28Cycles);
	ADC_RegularChannelConfig(ADC3, adc[6].ADC_CH,14, ADC_SampleTime_28Cycles);
	ADC_RegularChannelConfig(ADC3, adc[5].ADC_CH,15, ADC_SampleTime_28Cycles);
	ADC_RegularChannelConfig(ADC3, adc[4].ADC_CH,16, ADC_SampleTime_28Cycles);
...
void adc_initialize(void)
{
	...
	ADC_InitStructure.ADC_ExternalTrigConvEdge = ADC_ExternalTrigConvEdge_Falling;//open external trigger
